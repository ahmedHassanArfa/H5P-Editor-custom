...
(function ($) {
   ...
   * @private
   */
  var createDataView = function createDataView(dataView, wrapper, loaded) {
    new H5PDataView(wrapper, dataView.source, dataView.headers, dataView.l10n, {
      table: 'wp-list-table widefat fixed'
    }, dataView.filters, loaded, dataView.order);
  };

  /**
   * @private
   */
  var insertionDataView = function insertionDataView(id) {
    var $wrapper;
